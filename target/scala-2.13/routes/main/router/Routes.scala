...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """companies""", """controllers.HomeController.companies()"""),
  ...
  // @LINE:10
  private[this] lazy val controllers_HomeController_companies3_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("companies")))
  )
  private[this] lazy val controllers_HomeController_companies3_invoker = createInvoker(
    HomeController_1.companies(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "companies",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:10
    case controllers_HomeController_companies3_route(params@_) =>
      call { 
        controllers_HomeController_companies3_invoker.call(HomeController_1.companies())
      }
